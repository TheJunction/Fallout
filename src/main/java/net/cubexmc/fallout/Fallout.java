...
public class Fallout extends JavaPlugin {
    ...
    public ItemStack getBook() {
        ...
        bm.addPage("II : Radiation\n-------------------This is a post- apocalyptic world, in the aftermath of a nuclear war. Radiation from this nuclear fallout affects everything, forcing survivors under 4 xp levels to work to protect from radiation and enemy settlements.");
